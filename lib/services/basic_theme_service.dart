...
class BasicThemeService {
  ...
  Color getContainerColor(Color color) => _getColorFromTone(color, _containerColorTone);
  Color getOnContainerColor(Color color) => _getColorFromTone(color, _onContainerColorTone);
  Color getOnSurfaceVariantColor(Color color) =>
      _getColorFromTone(color, _onSurfaceVariantColorTone);

  Color _getColorFromTone(Color color, int tone) {
    final palette = CorePalette.of(color.toARGB32());
